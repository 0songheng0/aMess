...
import com.family.messenger.databinding.ItemMessageReceivedBinding
import com.family.messenger.databinding.ItemMessageSentBinding
...
class MessagesAdapter(
    ...
    class SentMessageViewHolder(
        ...
        fun bind(message: Message) {
            ...
            binding.timeTextView.text = formatTime(message.timestamp)
        }
    }
